...
namespace WeatherApp.Core
{
    public class FiveDayCore
    {
        public static async Task<List<Weather>> GetWeather(string City)
        {
            ...
            weather0.AirPressure = (string)results["list"][1]["main"]["pressure"] + " hpa";
            weather0.ImageName = (string)results["list"][1]["weather"][0]["icon"];
            ...
            weather1.AirPressure = (string)results["list"][9]["main"]["pressure"] + " hpa";
            weather1.ImageName = (string)results["list"][9]["weather"][0]["icon"];
            ...
            weather2.AirPressure = (string)results["list"][17]["main"]["pressure"] + " hpa";
            weather2.ImageName = (string)results["list"][17]["weather"][0]["icon"];
            ...
            weather3.AirPressure = (string)results["list"][25]["main"]["pressure"] + " hpa";
            weather3.ImageName = (string)results["list"][25]["weather"][0]["icon"];
            ...
            weather4.AirPressure = (string)results["list"][33]["main"]["pressure"] + " hpa";
            weather4.ImageName = (string)results["list"][33]["weather"][0]["icon"];
